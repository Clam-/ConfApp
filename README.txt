...
~/env/bin/python confapp/scripts/csvProcess2016People.py development.ini ~/ConfApp-files/2016/presenters.csv
~/env/bin/python confapp/scripts/csvProcess2016Host.py development.ini ~/ConfApp-files/2016/hosts.csv
~/env/bin/python confapp/scripts/csvProcess2016Shirt.py development.ini ~/ConfApp-files/2016/shirts.csv
~/env/bin/python confapp/scripts/csvProcess2016Handout.py development.ini ~/ConfApp-files/2016/handouts.csv
